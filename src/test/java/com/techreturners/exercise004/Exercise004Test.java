...
public class Exercise004Test {
    ...
    @Test
    public void checkGetDateTimeWhenDateIsString()  {
        Exercise004 ex004 = new Exercise004("2021-01-24.23:59:59");
        LocalDateTime expected = LocalDateTime.of(2052, Month.OCTOBER, 3, 1, 46, 39);
        assertEquals(expected, ex004.getDateTime());
    }

    @Test
    public void checkGetDateTimeWhenDateAsStingIsEmpty() {
        Exercise004 ex004;
        DateTimeException exception =  assertThrows(DateTimeException.class, () -> new Exercise004(""));
